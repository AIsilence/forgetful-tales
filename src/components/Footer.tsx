    ...
    <footer className="relative noise-bg border-t border-silence-purple/20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            <div className="mb-4">
              <h3 className="text-2xl font-bold text-white mb-2">SILENCE</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="text-white/60 hover:text-silence-purple transition-colors">About Silence</a>
              </li>
              <li>
                <a href="#story" className="text-white/60 hover:text-silence-purple transition-colors">Experience the Story</a>
              </li>
              <li>
                <a href="#tokenomics" className="text-white/60 hover:text-silence-purple transition-colors">Tokenomics</a>
              </li>
              <li>
                <a href="#roadmap-section" className="text-white/60 hover:text-silence-purple transition-colors">Roadmap</a>
              </li>
              <li>
                <a href="#community" className="text-white/60 hover:text-silence-purple transition-colors">Community</a>
              </li>
            </ul>
          </div>
